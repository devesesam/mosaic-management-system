/*
  # Emergency Fix for Data Display
  
  1. Security
    - Disable Row Level Security on all tables to ensure data visibility
  
  2. Sample Data
    - Add sample workers with admin roles
    - Add sample jobs with specific dates and workers
    - Add unscheduled jobs
    - Ensure the current user has an admin worker account
*/
