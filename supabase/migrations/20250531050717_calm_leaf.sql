...
CREATE POLICY IF NOT EXISTS "Allow public read access to workers"
  ON public.workers
  FOR SELECT
  TO public
  USING (true);

CREATE POLICY IF NOT EXISTS "Allow public insert to workers"
  ON public.workers
  FOR INSERT
  TO public
  WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Allow public update to workers"
  ON public.workers
  FOR UPDATE
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow public delete from workers"
  ON public.workers
  FOR DELETE
  TO public
  USING (true);
...
CREATE POLICY IF NOT EXISTS "Allow public read access to jobs"
  ON public.jobs
  FOR SELECT
  TO public
  USING (true);

CREATE POLICY IF NOT EXISTS "Allow public insert to jobs"
  ON public.jobs
  FOR INSERT
  TO public
  WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Allow public update to jobs"
  ON public.jobs
  FOR UPDATE
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow public delete from jobs"
  ON public.jobs
  FOR DELETE
  TO public
  USING (true);
...
CREATE POLICY IF NOT EXISTS "Allow public read access to job_secondary_workers"
  ON public.job_secondary_workers
  FOR SELECT
  TO public
  USING (true);

CREATE POLICY IF NOT EXISTS "Allow public insert to job_secondary_workers"
  ON public.job_secondary_workers
  FOR INSERT
  TO public
  WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Allow public update to job_secondary_workers"
  ON public.job_secondary_workers
  FOR UPDATE
  TO public
  USING (true)
...
CREATE POLICY IF NOT EXISTS "Allow public delete from job_secondary_workers"
  ON public.job_secondary_workers
  FOR DELETE
  TO public
  USING (true);
