-- This migration adds public read access to all tables while maintaining authenticated write access
...
-- Create public read access to workers
...
-- Create authenticated write access to workers
...
-- Create public read access to jobs
...
-- Create authenticated write access to jobs
...
-- Create public read access to job_secondary_workers
...
-- Create authenticated write access to job_secondary_workers
