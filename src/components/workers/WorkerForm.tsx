          ...
          <div className="flex justify-end space-x-3 pt-4 border-t">
            ...
            {!readOnly && (
              <button
                ...
                className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blueberry hover:bg-blueberry/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-margaux disabled:opacity-50"
              >
                {isSubmitting ? (
